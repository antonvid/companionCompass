...
server = socket.socket(socket.AF_INET, socket.SOCK_STREAM) # create server socket using IP and TCP
print("server started!")

server.bind(('', 13093)) # bind server to local address and port 13093

server.listen(1) # listen, only allow one connection
