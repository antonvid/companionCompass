...
int main()
{
	...
	const int timeout = 1200; // Set timeout to 20 minutes (1200 seconds)
	const int reset_timeout = 1; // whether to reset the timer on a received scan event (continuous scanning)
